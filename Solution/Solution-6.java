...
public class program10 { 
	...
	public String reverse() {
		StringBuilder sb = new StringBuilder(str); return sb.reverse().toString();
	}
	public String titleCase() {
		String[] words = str.split("\\s+"); StringBuilder sb = new StringBuilder();
	...
	public static void main(String[] args) {
		...
		program10 myString = new program10(inputString);
		while (true) {
			System.out.println("\nSelect an option:");
